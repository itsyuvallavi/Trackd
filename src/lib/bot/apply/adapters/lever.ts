...
export async function fillLeverApplication(
  ...
  logApply('lever_start', { url: truncate(url, 120), job: truncate(`${job.title} @ ${job.company}`, 80) })
